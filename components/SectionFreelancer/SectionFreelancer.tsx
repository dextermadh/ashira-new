...
import freelancer from '../../public/media/freelancer-icon.webp'
    ...
    <div className="m-12 mt-[25 0px]">
      <div className="min-h-[40px]">
        ...
        <div className="flex text-[18px] md:text-[20px] gap-2">
          <div className="mt-1">
            <Phone className="w-4 md:w-5" color="white"/>
          </div>
          <span className="mt-1 text-white">+94761222577</span>
        </div>

        <div className="flex m-0 text-[18px] md:text-[20px] gap-2">
          <div className="mt-1">
            <Mail className="w-4 md:w-5" color="white"/>
          </div>
